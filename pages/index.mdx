...
Examples for the API are written in HTTP, which allows for language agnostic examples. You're not expected to learn HTTP but if you look at the examples, you may learn it anyways. To run the examples you can use Swagger, POSTMAN, VSCode or your preferred mechanism for making http requests.
